        ...
        case PROTO_GET_CANBUS_PARAMS:
            ...
            if (NUM_BUSES > 1)
            {
                transmitBuffer[transmitBufferLength++] =
                    settings.canSettings[1].enabled + ((unsigned char)settings.canSettings[1].listenOnly << 4);
            ...
            {
                // disabled/nonexistent second bus
            ...
            if (SysSettings.numBuses > 1)
            {
                ...
                if (settings.canSettings[1].enabled)
                {
                    if (canBuses[1])
                    {
                        ...
                        canBuses[1]->setListenOnlyMode(
                            settings.canSettings[1].listenOnly,
